...
class Result {
  ...
  factory Result.fromJson(Map<String, dynamic> json) => Result(
    ...
    backdropPath: json["backdrop_path"], // อาจเป็น null
    ...
    posterPath: json["poster_path"], // อาจเป็น null
    releaseDate:
...
enum OriginalLanguage { EN, KO, ZH }
...
class EnumValues<T> {
  ...
  // เพิ่มเมธอดสำหรับการจัดการค่าที่ไม่พบในแผนที่
  T getValueOrDefault(String? key, T defaultValue) {
